...
<html>
    <head>
    <title>Daftar Peserta Praktikum - COLABS</title>
    ...
    if (isset($_SESSION['Peran'])) {
        if ($_SESSION['Peran'] == 'Admin') {
            echo '<link rel="stylesheet" href="Style/Admin/daftarpesertapraktikum.css">';
        }else {
    ...
    <body>
        ...
        <div class="content">
            <h1>DAFTAR PESERTA PRAKTIKUM</h1>
            <p>Nama, Praktikum, Tahun, Kurikulum</p>
        <div class="table-box">
